...
const EditorToolbar = ({
  ...
  return (
    <div className="w-full h-12 flex justify-normal md:justify-center items-center px-1 gap-0.5 bg-content1 border-t border-divider z-50 fixed bottom-0 left-0">
      <div className="max-w-[768px] flex overflow-x-auto hideScrollbar">
        {editor && (
          <>
