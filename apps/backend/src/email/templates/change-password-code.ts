export const changePasswordCodeTemplate = (code: string) => `
<!DOCTYPE html>
<html>
<body style="font-family: sans-serif; background: #f9f9f9; padding: 40px;">
  <div style="max-width: 480px; margin: 0 auto; background: #fff; border-radius: 12px; padding: 32px; border: 1px solid #e5e5e5;">
    <h2 style="margin-top: 0; color: #111;">Confirm your password change</h2>
    <p style="color: #555;">You requested to change your account password.</p>
