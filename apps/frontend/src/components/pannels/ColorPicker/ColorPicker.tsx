...
export const ColorPicker = ({ color, onChange, onClear }: ColorPickerProps) => {
  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <input
        type="text"
        className="w-full p-2 text-black bg-white border rounded-sm dark:bg-black dark:text-white border-neutral-200 dark:border-neutral-800 focus:outline-1 focus:ring-0 focus:outline-neutral-300 dark:focus:outline-neutral-700"
        placeholder="#000000"
